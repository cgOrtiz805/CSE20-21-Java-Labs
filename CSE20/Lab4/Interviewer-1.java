...
public class Interviewer {
	...
	public static void main(String[] args) {
		...
		String name1;
		 ...
		 name3 = input.next();
		 System.out.print("Thier hobby is ");
		 System.out.println(name3);
		 
		 String name4;
		 System.out.print("What do u hate? ");
		 name4 = input.next();
		 System.out.print("They hate ");
		 ...
		 int n1, weight;
		 System.out.println("What is their wieght?");
		 
		 n1 = input.nextInt();
		 weight = (int) (n1/2.2);
		 System.out.print("They weight: " + weight + "kg. ");
